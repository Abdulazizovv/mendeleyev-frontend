...
export default function CreateIncomeModal({
  ...
  const { data: categoriesData } = useQuery({
    ...
    queryFn: () => financeApi.getCategories({ type: "income", is_active: true }),
    enabled: open,
  });
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("Kirim tranzaksiyasi muvaffaqiyatli yaratildi");
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-green-600">
            ...
            Kirim tranzaksiyasi yaratish
          </DialogTitle>
          <DialogDescription>
            Kassaga kirim qo'shish uchun ma'lumotlarni kiriting
          </DialogDescription>
        </DialogHeader>
