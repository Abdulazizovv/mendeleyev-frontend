              ...
              <div>
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1">
                  ...
                  {student.current_class?.name && (
                    <button
                      onClick={() => router.push(`/branch-admin/classes/${(student.current_class as any).id}`)}
        ...
        <Card className="border-gray-200 shadow-none">
          ...
          <CardContent className="px-5 pb-5 pt-0">
            ...
            <InfoRow icon={GraduationCap} label="Sinf"
              ...
              onClick={() => student.current_class && router.push(`/branch-admin/classes/${(student.current_class as any).id}`)} />
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                ...
                <div className="space-y-2">
                  {groups.map((g: any) => (
                    <button
                      key={g.id}
                      onClick={() => router.push(`/branch-admin/groups/${g.id}`)}
      ...
      <Card className="border-gray-200 shadow-none">
        <CardHeader className="px-5 pt-5 pb-3">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => router.push(`/branch-admin/students/${studentId}/transactions`)}
