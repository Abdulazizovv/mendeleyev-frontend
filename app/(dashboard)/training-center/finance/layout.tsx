...
const BASE = "/training-center/finance";

const operations = [
  { label: "Umumiy", href: BASE, exact: true, icon: LayoutDashboard },
  { label: "Tranzaksiyalar", href: `${BASE}/transactions`, icon: Receipt },
  { label: "To'lovlar", href: `${BASE}/payments`, icon: CreditCard },
  { label: "Balanslar", href: `${BASE}/student-balances`, icon: Users },
];
