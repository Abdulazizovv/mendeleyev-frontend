...
export default function CreatePaymentPage() {
  ...
  // O'quvchi tanlanganda avtomatik to'ldirish
  ...
  const createPaymentMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      router.push("/training-center/finance/payments");
    },
    ...
    <div className="max-w-4xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-3">
        <Button
          ...
          size="icon"
          className="shrink-0"
          onClick={() => router.push("/training-center/finance/payments")}
        >
            ...
            <Card className="border-gray-200">
              <CardContent className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-medium text-gray-600">To&apos;lov sanasi</Label>
